  ...
  <div class="tags-view__container">
    ...
    >
      ...
      >
        {{
          generateTitle(
            tag.path === route.meta.activeMenu
              ? route.meta.title
              : tag.meta.title
          )
        }}
    ...
    >
      <li @click="refreshSelectedTag(selectedTag)">
        <jw-svg-icon icon-class="refresh" />
        刷新
      </li>
      ...
      <li @click="closeOtherTags">
        <jw-svg-icon icon-class="close_other" />
        关闭其它
      </li>
      <li v-if="!isFirstView()" @click="closeLeftTags">
        <jw-svg-icon icon-class="close_left" />
        关闭左侧
      </li>
      <li v-if="!isLastView()" @click="closeRightTags">
        <jw-svg-icon icon-class="close_right" />
        关闭右侧
      </li>
      <li @click="closeAllTags(selectedTag)">
        <jw-svg-icon icon-class="close_all" />
        关闭所有
      </li>
    </ul>
  </div>
